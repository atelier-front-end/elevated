...
const Breakdown = ({ productID, ratingsArray, setCharBreak, starFilter, setStarFilter }) => {
  ...
  return (
    <BreakdownCont>
      <RatingsBrk breakdown={breakdown} ratingsArray={ratingsArray} starFilter={starFilter} setStarFilter={setStarFilter}/>
      <div>
