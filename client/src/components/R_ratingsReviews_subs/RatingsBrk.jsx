...
const RatingsBrk = function RatingsBrk({
  breakdown,
  ratingsArray,
  starFilter,
  setStarFilter,
  ...
  const recommendedPercent = function recPerc(obj) {
    let rawNum =
      Number.parseInt(obj.true) /
      (Number.parseInt(obj.true) + Number.parseInt(obj.false));
            ...
            return (
              <div key={index} onClick={(e) => clickHandler(e, rating)}>
                ...
                <RatingSelector
                  style={{
                    textDecoration: `${
                      starFilter[rating] ? "underline" : "none"
                    }`,
                  }}
                >
                  {rating} stars
                ...
                <BarContainerStyles>
                  <BarFiller style={{ width: `${stats.ratings[rating]}%` }}>
